...
### **Total Interview Questions (Consolidated): 19**

**Note:** I intentionally merged follow-up prompts like **"How do you configure that?"**, **"Can you explain?"**, **"Where do you set that?"**, **"How do you set up those checks?"**, etc., into their respective main questions because they were probing the same topic rather than introducing a new interview question. This preserves the interview flow while making the list more useful for revision. 
Below are **all interviewer questions** in the **exact interview flow**, with follow-up questions **merged into the main question** wherever they were simply rephrasing, probing deeper, or asking for clarification. I've also **highlighted the important keywords** for easier revision. This list is based directly on the transcript. 
